programa
{
	...
	funcao real calculaValorHoraExtra(real salarioBruto)
	{    
		const inteiro HORA_MENSAL = 220
		const real EXTRA_50 = 1.5
		const real EXTRA_100 = 1.6
		inteiro horas_adicionais=0
		real valor_extra
		real horaExtraTotal
		real salarioAdicionado
	...
	funcao simulador_horas_extras()
	{
		...
		escreva("Informe seu salario Bruto:\n")
	     ...
	     total_extra = salarioBruto/HORA_MENSAL
	}
 ...
 * 
 * @POSICAO-CURSOR = 4228; 
 * @DOBRAMENTO-CODIGO = [4, 25, 71, 82, 94, 131, 115, 146, 159, 169, 185, 200, 229, 243, 254, 258, 284, 311, 319, 328, 333, 345, 381, 400];
 * @PONTOS-DE-PARADA = ;
